...
pub mod module_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn watch_module(
            ...
            tonic::Response<super::ModuleNotifyReply>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/bilibili.broadcast.message.fawkes.Module/WatchModule",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "bilibili.broadcast.message.fawkes.Module",
                        "WatchModule",
                    ),
                );
...
pub mod module_server {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/bilibili.broadcast.message.fawkes.Module/WatchModule" => {
                    ...
                    struct WatchModuleSvc<T: Module>(pub Arc<T>);
                    impl<T: Module> tonic::server::UnaryService<()>
                    for WatchModuleSvc<T> {
                        type Response = super::ModuleNotifyReply;
                        ...
                        fn call(&mut self, request: tonic::Request<()>) -> Self::Future {
                            ...
                            let fut = async move {
                                <T as Module>::watch_module(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let fut = async move {
                        let method = WatchModuleSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
    ...
    pub const SERVICE_NAME: &str = "bilibili.broadcast.message.fawkes.Module";
