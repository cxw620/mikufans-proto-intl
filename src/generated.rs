...
pub mod bilibili {
    ...
    pub mod broadcast {
        ...
        pub mod message {
            ...
            pub mod fawkes {
                include!("bilibili.broadcast.message.fawkes.rs");
            }
            pub mod gamecenter {
            ...
            pub mod intl {
                include!("bilibili.broadcast.message.intl.rs");
            }
            pub mod main {
    ...
    pub mod intl {
        pub mod app {
            pub mod interfaces {
                pub mod v1 {
                    include!("bilibili.intl.app.interfaces.v1.rs");
                }
                pub mod v2 {
                    include!("bilibili.intl.app.interfaces.v2.rs");
                }
            }
        }
        pub mod metadata {
            include!("bilibili.intl.metadata.rs");
        }
    }
    pub mod live {
        pub mod app {
